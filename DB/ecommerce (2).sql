...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2018 at 08:24 PM
...
(3, 4, 2, 'Mobile', 'Mobile', '<font face=\"Arial, Verdana\"><span xss=\"removed\">Mobile</span></font>', 4, 'uploads/xperia.jpg', 20000.00, 1, 2),
...
(9, 9, 9, 'Digital Therapy Machine', 'Digital Therapy Machine', '<font face=\"Arial, Verdana\"><span xss=removed>Digital Therapy Machine</span></font>', 18, 'uploads/Digital_Therapy_Machine.jpg', 700.00, 1, 1),
(10, 10, 10, 'Electronic Back Support', 'Electronic Back Support', '<font face=\"Arial, Verdana\"><span xss=\"removed\">Electronic Back Support</span></font>', 14, 'uploads/Ele.jpg', 800.00, 0, 1),
(11, 11, 11, 'Blood Pressure Monitor', 'Blood Pressure Monitor', '<h1 class=\"title\" xss=removed>Blood Pressure Monitor</h1>', 14, 'uploads/blood.jpg', 3000.00, 1, 1),
...
--
ALTER TABLE `order_details`
  MODIFY `order_details_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
