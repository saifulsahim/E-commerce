...
<div class="features_items"><!--features_items-->
    ...
    <?php
        foreach ($all_active_product as $v_product)
        {
    ?>
...
<!--                        --><?php //echo base_url()?><!--product-details/--><?php //echo $v_product->product_id?>
                        ...
                        <a href="javascript:void(0)" class="btn btn-default add-to-cart" data-id="<?php echo $v_product->product_id?>" data-name="<?php echo $v_product->product_name?>"
                             ...
                             data-image="<?php echo $v_product->product_image?>"  data-price="<?php echo $v_product->product_price?> "
