...
<head>
    ...
    <style type="text/css">
        body {
            background: url(<?php echo base_url()?>asset/admin_asset/img/bg-login.jpg) !important;
        }
    </style>
                ...
                <form class="form-horizontal" action="<?php echo base_url()?>admin-login" method="post">
                    <fieldset>
                        ...
                        <div class="input-prepend" title="Username">
                            ...
                            <input class="input-large span10" name="userEmail" id="username" type="text"
                        ...
                        <div class="input-prepend" title="Password">
                            ...
                            <input class="input-large span10" name="userPassword" id="password" type="password"
