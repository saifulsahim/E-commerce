        ...
        <div id="sidebar-left" class="span2">
            <div class="nav-collapse sidebar-nav">
                <ul class="nav nav-tabs nav-stacked main-menu">
                    <li><a href="javascript:void(0)"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a>
                    </li>
                    <li><a href="<?php echo base_url('register-admin')?>"><i class="icon-envelope"></i><span
                                    class="hidden-tablet"> Add Admin</span></a></li>

                    <li><a href="<?php echo base_url('manage-admin')?>"><i class="icon-envelope"></i><span
                                    class="hidden-tablet"> Manage Admin</span></a></li>

                    <li><a href="<?php echo base_url('add-category')?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Category</span></a>
                    </li>
                    <li><a href="<?php echo base_url('all-category')?>"><i class="icon-eye-open"></i><span
                                    class="hidden-tablet"> Manage Category </span></a></li>
                    <li><a href="<?php echo base_url('add-product')?>"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Product</span></a>
                    </li>
                    <li><a href="<?php echo base_url('manage-product')?>"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage Product</span></a>
                    </li>
                    <li><a href="<?php echo base_url('add-manufacturer')?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Manufacturer</span></a>
                    </li>
                    <li><a href="<?php echo base_url('manage-manufacturer')?>"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage Manufacturer</span></a>
                    </li>
                    <li><a href="<?php echo base_url('manage-invoice')?>"><i class="icon-dashboard"></i><span class="hidden-tablet">Manage Invoice</span></a>
                    </li>
                    <li>
